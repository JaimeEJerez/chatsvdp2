...
public class SendVerifCode
{
    private String      eMail;

    public static abstract class EventHandler
    {
        public abstract void finish( String uuid, String error );
    }

    public SendVerifCode( String eMail )
    {
        this.eMail = eMail;
    }
    ...
    public void execute( final EventHandler eventHandler)
    {
        Thread thread = new Thread()
        {
            public void run()
            {
                ...
                try
                {
                    String urlStr = Constants.kProtocol + Constants.kAPIEntryPoint + "/user/SendVerifCode?email=" + eMail;
                ...
                finally
                {
                    ...
                    {
                        eventHandler.finish( uuid, error );
                    }
                }
            }
        };
